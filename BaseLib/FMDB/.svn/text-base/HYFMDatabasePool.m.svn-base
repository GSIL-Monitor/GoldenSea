...
@interface HYFMDatabasePool()

- (void)pushDatabaseBackInPool:(HYFMDatabase*)db;
- (HYFMDatabase*)db;

@end


@implementation HYFMDatabasePool
...
- (HYFMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [HYFMDatabase databaseWithPath:self->_path];
