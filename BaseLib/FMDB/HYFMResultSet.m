...
@implementation HYFMResultSet
@synthesize query=_query;
@synthesize statement=_statement;

+ (instancetype)resultSetWithStatement:(HYFMStatement *)statement usingParentDatabase:(HYFMDatabase*)aDB {
    
    HYFMResultSet *rs = [[HYFMResultSet alloc] init];
...
- (void)setParentDB:(HYFMDatabase *)newDb {
    _parentDB = newDb;
}
