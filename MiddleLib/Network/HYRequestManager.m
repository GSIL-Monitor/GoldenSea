...
+(void)registerRequest:(NSString *)requestClassString withResponse:(NSString *)responseClassString
{
    ...
    [manager.responseDict setValue:responseClassString forKey:requestClassString];
}


+(HYBaseResponse*)responseWithRequst:(NSString *)requestClassString
{
    NSString* responseClassString = [[HYRequestManager sharedInstance].responseDict valueForKey:requestClassString];
...
{
    HYRequestManager* manager = [HYRequestManager sharedInstance];
    [manager.modelDict setValue:modelClassString forKey:requestClassString];
}
